<template>
  <div
    class="fixed top-0 left-0 w-screen h-screen md:w-full md:h-full bg-color-modal md:bg-color-gray-deep z-30 overflow-y-scroll"
  ...
  >
    ...
    >
      ...
      <div class="w-full flex gap-2">
        <button
          class="basis-1/2 px-4 md:px-10 py-2 rounded-md"
          :class="{
